      ...
      <div className='content'>
        <div className='stats'>
          <div className='left'>
            <div className='row'>
              <h4>24 Hour Low</h4>
             {coin.market_data_24h && coin.market_data_24h.low_24h ? (
  <p>{coin.market_data_24h.low_24h.usd.toLocaleString()}</p>
) : null}
            </div>
            <div className='row'>
              <h4>24 Hour High</h4>
              {coin.market_data_24h && coin.market_data_24h.high_24h ? (
  <p>{coin.market_data_24h.high_24h.usd.toLocaleString()}</p>
) : null}
            </div>
          </div>
          <div className='right'>
